...
|---|---|---|
| Normative requirement or layer meaning | `standard/` | Matching installed copy under `src/verifier/specifications/`, compatibility analysis, schema/model/runtime review, and falsification test |
...
- identify the affected VSTD layer, repository release, and exact coordinate or seam;
- state compatibility effects, including frozen wire identifiers and historical receipts;
