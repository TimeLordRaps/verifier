...
| [W3C PROV](https://www.w3.org/TR/prov-overview/) | A model and serializations for interoperable exchange of provenance about entities, activities, and agents. | A mapping between a declared GRAPH profile and identified PROV records, with unmapped fields reported. | W3C endorsement, automatic semantic equivalence, or completeness of a provenance record. |
