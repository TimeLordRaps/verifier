...
is current. The first bound record is the ZIZK experiment. A blocked experiment remains
eligible for indexing once its intentional files are isolated and its manifest honestly
records the blocker; indexing is not publication of a positive result.
