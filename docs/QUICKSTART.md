...
built-in checker. The second lists the nine executable domain adapters — DATA,
ENV, BENCH, HYPER, MODEL, SIM, HARNESS, AGENT and BOT — and their per-check dependency
graphs.
