#!/usr/bin/env python3
"""Build the Verifier Standard (VSTD) Monograph PDF from authoritative specification and architectural sources.
...
def clean_markdown_for_pandoc(text: str, chapter_title: str) -> str:
    ...
    # Demote existing headings so the chapter title becomes # and existing # becomes ##, etc.
    lines: list[str] = []
