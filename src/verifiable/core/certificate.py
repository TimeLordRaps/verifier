...
every CNF currently produced by :mod:`verifiable.data.policy` is Horn -- and
...
class CostTier(str, Enum):
    """Declared checking-cost class. See :func:`verifiable.core.kernel.tightest_tier`."""
...
# ``verifiable.core.receipt``: that module imports the solver-side auditor, and
