...
:mod:`verifiable.core.certificate` and :mod:`verifiable.core.grounding`, both of
...
:mod:`verifiable.core.refutation`. That duplication is deliberate and must not
...
def is_horn(formula: Sequence[Sequence[int]]) -> bool:
    ...
    ``verifiable.data.policy`` is Horn.
    """
