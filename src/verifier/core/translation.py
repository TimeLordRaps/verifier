...
VSTD's SAT/FSM verifiers (``VFY-000001``, ``VFY-PUBLIC-000001``) and the
generic run primitive (``verifier.core.run``) both answer "does this formal
...
1. A reusable, translator-agnostic record shape (:class:`TranslationUnit`,
   ...
   canonical-JSON/digest machinery as ``verifier.core.receipt`` so
