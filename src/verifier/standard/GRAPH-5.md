...
**Numbered profile:** GRAPH-5; required closure coordinate: Corroborated Verification Network (see `LADDER.md`)
**Status:** project specification with implemented candidate and evidence-bound reference paths
**License:** Apache-2.0

GRAPH-5 is the collection profile for independently corroborated members,
...
self-declared ratings is not GRAPH-5
conformance.
