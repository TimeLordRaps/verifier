...
from verifier.constraints.kernel import (
...
from verifier.constraints.torch_mask import apply_packed_token_mask_inplace
...
def _load_llguidance() -> Any:
    try:
        ...
        raise RuntimeError("llguidance is required; install verifier-standard[llguidance]") from exc
    return llguidance
    ...
    def from_huggingface(cls, hf_tokenizer: Any, *, n_vocab: Optional[int] = None) -> "LLGuidanceBackend":
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "verifier-standard does not install it automatically"
            ) from exc
