...
The reference implementation is `verifiable.core.depth`.
...
declarant. The reference kernel is `verifiable.core.kernel`; it imports no solver
or policy producer.
...
* `src/verifiable/core/certificate.py`
* `src/verifiable/core/grounding.py`
* `src/verifiable/core/depth.py`
* `src/verifiable/core/refutation.py`
* `src/verifiable/layer4/`

The trusted checker is `src/verifiable/core/kernel.py`. Producer modules are not
