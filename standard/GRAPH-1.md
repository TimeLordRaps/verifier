...
The frozen `verifier-data-1` serialization defines artifact and transformation identifiers
...
establishment, and `verifier-graph-assurance-1` require the two sets to be globally
