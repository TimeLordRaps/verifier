...
- No cryptographic guarantee is invented. Signature and revocation results enter as
  asserted evidence produced by some real protocol named by the deployment, and the model
  decides only what may be concluded from them.
