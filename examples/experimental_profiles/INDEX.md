...
|---|---|---|---|---:|---|
| experiment-artifact-first-mechanisms | RUNNING | Which remaining domain-specific TRUST (mechanism-earned forward artifact support) transfer rules, ROT (typed time-indexed current-admissibility degradation) policies, RUST (inverse-TRUST diagnostic backtrace) localization mechanisms, hidden-witness trichotomy mechanisms, and independent implementations can extend the shipped reference event/dispatch substrate without actor reputation, scalar cancellation, causal-localization overclaim, or making the governing orientation contingent on the study? | CANDIDATE | 6 | [`examples/experimental_profiles/artifact_first_mechanisms/experiment.json`](artifact_first_mechanisms/experiment.json)<br>`sha256:3d6bcf9c7812ff7381628d604e98b478447513aa486f05814a7c4dfd3733d0da` |
| experiment-github-verdict-neutrality | COMPLETED | Does the GitHub adapter preserve successful workflow and merge states without converting them into a VSTD verdict? | INTERNAL | 1 | [`examples/experimental_profiles/github_verdict_neutrality/experiment.json`](github_verdict_neutrality/experiment.json)<br>`sha256:3b98310d35c20e7099d242e2c655e4bf8dc62d91298adc04e4dc2f56f2f79d89` |
