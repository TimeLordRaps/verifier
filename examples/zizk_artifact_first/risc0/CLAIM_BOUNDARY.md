...
ZIZK artifact-first architecture. It neither creates that architecture nor makes its
specific proof system mandatory. No frozen wire identifier, schema, canonical digest,
lifecycle token, console alias, or existing receipt interpretation changes.
